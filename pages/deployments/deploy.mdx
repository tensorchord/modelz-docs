...
- **Build and deploy a new project from scratch (WIP)**. You could visit the [**Build**](../deployment/build) page to learn how to build a new inference server and push it to a Docker Registry.
...
For example, this happens through detecting which framework you're using, and then selecting the right [autoscaling settings](../concepts/autoscaler) for your project automatically.
