...
<DeployButton style={{marginTop: '12px'}} link='https://cloud.modelz.ai/templates?templateId=993edd4b-4f3a-4560-bad3-b20954f95335'/>
...
You could deploy our pre-built Gradio app [here](https://cloud.modelz.ai/templates) if you want to quickly try out Stable Diffusion.
