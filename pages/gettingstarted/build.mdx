...
You could also use our pre-built [**Templates**](../frameworks/templates) directly. These templates could help simplify and expedite the deployment process.
...
- [**Streamlit**](../frameworks/streamlit): a framework for building ML model-enabled web apps.
- [**Gradio**](../frameworks/gradio): a simple and flexible framework for building ML model-enabled web apps.
- [**Other**](../frameworks/other): you could also use your own frameworks to deploy your models.

Here we take [**Mosec**](../frameworks/mosec) as an example to show how to build a Docker image for the [**Stable Diffusion**](../frameworks/mosec/stable-diffusion).
