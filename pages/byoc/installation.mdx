...
If you want to add other VM as a node of your cluster, you can refer this [document](https://docs.open.modelz.ai/).
...
After the installation, you can see your own cluster status on the ModelZ control dashboard.
