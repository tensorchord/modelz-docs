...
- Firstly, you can refer to the [install document](./installation.mdx) to install the agent components.
...
- The data plane, deployed within your private environment, creates resources related to the inference models, such as deployments and services. If you want to expose your model deployment to the internet, it will create additional ingress for external access. 
...
- Besides, we also have an ingress operator to provide endpoints for the deployments. It is not shown in the diagram.
