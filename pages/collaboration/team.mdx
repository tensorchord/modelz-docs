...
The user that creates the team is automatically set as the `Owner` of the team. The owner can assign any other roles within the team, as well as pending other members of the workspace.
