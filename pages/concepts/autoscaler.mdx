...
The autoscaler scales inference servers horizontally between a minimum and maximum number of replicas, or to zero.
...
These options are available in the [**project**](./project). You could configure them in the dashboard.