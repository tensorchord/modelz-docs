...
- Once your model is ready, feel free to start using it! You could take advantage of our [**SDK**](./sdk) to easily make calls to your model.
...
```bash copy
curl --location 'http://cloud.modelz.ai/api/v1/mosec/inference/{DEPLOYMENT_ID}.{UID}/inference' \
