...
- Deploy your first model on ModelZ. You could use our [**templates**](./frameworks/templates). ModelZ's serverless architecture means you don't need to worry about managing or scaling infrastructure - we take care of that for you.
...
- Once your model is ready, feel free to start using it! If you deployed a model with [**Gradio**](./frameworks/gradio), you could access it by the URL `https://<deployment-id>.modelz.io` provided in the deployment page.
  ...
  cli = modelz.ModelzClient(key=APIKey, deployment="abcdgefg...", timeout=10)
