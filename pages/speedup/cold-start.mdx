...
To mitigate the impact of the size of your model and related dependencies on the performance of your inference, we cache the public images, **and the public models on Huggingface** on the platform.
